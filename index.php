       ...
       <a class="skip-link screen-reader-text" href="#content">Skip to content</a>
        ...
        <main id="content">
            <div class="wrapper">
                ...
                <article>
                    <a href="new-york-post-redesign.php?key=0" class="project p01">
                ...
                <article>
                    <a href="twd-landing-page.php?key=1" class="project p02">
                ...
                <article>
                    <a href="javascript-jquery.php?key=2" class="project p03">
